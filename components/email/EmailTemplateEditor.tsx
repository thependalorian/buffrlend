...
type EmailType = 'document_invitation' | 'loan_approval' | 'loan_rejection' | 'payment_reminder' | 'welcome' | 'custom' | 'signature_reminder' | 'document_signed' | 'document_completed' | 'document_expired' | 'document_rejected' | 'document_viewed' | 'welcome_email' | 'password_reset';
