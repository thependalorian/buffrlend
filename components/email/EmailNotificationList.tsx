...
export default function EmailNotificationList({
  ...
  const {
    ...
    retryEmail,
    cancelEmail,
    getNotificationsByStatus: _getNotificationsByStatus,
    getNotificationsByType: _getNotificationsByType,
  ...
  const getTypeBadge = (type: EmailType) => {
    const typeConfig = {
      loan_application_confirmation: { color: 'badge-primary', text: 'Application' },
      loan_approval: { color: 'badge-success', text: 'Approval' },
      loan_rejection: { color: 'badge-error', text: 'Rejection' },
      partner_summary: { color: 'badge-info', text: 'Partner Summary' },
      employee_loan_confirmation: { color: 'badge-primary', text: 'Employee Loan' },
      salary_deduction_authorization: { color: 'badge-warning', text: 'Salary Deduction' },
      payment_reminder: { color: 'badge-warning', text: 'Payment Reminder' },
      welcome_email: { color: 'badge-accent', text: 'Welcome' },
      password_reset: { color: 'badge-ghost', text: 'Password Reset' },
      document_invitation: { color: 'badge-info', text: 'Document Invitation' },
      signature_reminder: { color: 'badge-warning', text: 'Signature Reminder' },
      document_signed: { color: 'badge-success', text: 'Document Signed' },
      document_completed: { color: 'badge-success', text: 'Document Completed' },
      document_expired: { color: 'badge-error', text: 'Document Expired' },
      document_rejected: { color: 'badge-error', text: 'Document Rejected' },
      document_viewed: { color: 'badge-info', text: 'Document Viewed' },
      system_notification: { color: 'badge-neutral', text: 'System Notification' },
      marketing_campaign: { color: 'badge-accent', text: 'Marketing Campaign' },
    } as const;
